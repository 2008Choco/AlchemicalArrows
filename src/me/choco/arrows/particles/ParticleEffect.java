package me.choco.arrows.particles;
...
import me.choco.arrows.particles.ReflectionUtils.PackageType;
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws VersionIncompatibleException {
			...
			try {
				...
				if (version > 7) {
					enumParticle = me.choco.arrows.particles.ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
				}
