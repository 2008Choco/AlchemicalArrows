...
/**
 * Represents a central registration for all alchemical arrows and their
 * activity in the world. Handles the creation, registration, deletion and
 * item management of all arrows
 * 
...
public class ArrowRegistry {
	...
	// Determins what ItemStack corresponds to what AlchemicalArrow type when registering arrows when shot
	...
	/** 
	 * Register an Alchemical Arrow. This is REQUIRED in order for AlchemicalArrows 
	 * to recognize that you are in fact shooting an Alchemical Arrow
	 * 
	 * @param item - The item variation of the Alchemical Arrow
	 * @param clazz - The class extending AlchemicalArrow
	 * 
	 * @throws IllegalArgumentException If ItemStack parameter is not of Material type ARROW
	 */
	...
	/** 
	 * Get the registry for all Alchemical Arrows. Mainly used for Alchemical Arrows registration
	 * purposes, but is free to use
	 * 
	...
	/** 
	 * Register an Arrow extending the AlchemicalArrow class. Used to keep track of living 
	 * arrow entities
	 * 
	 ...
	 * <br><b>NOTE:</b> This will prepare the arrow for deletion, and not immediately delete it 
	 * until the {@link #purgeArrows()} method is called
	 * 
	...
	/** 
	 * Unregister an AlchemicalArrow by its UUID.
	 * <br><b>NOTE:</b> This will prepare the arrow for deletion, and not immediately delete it
	 * until the {@link #purgeArrows()} method is called
	 * 
	...
	/** 
	 * Get a registered Arrow tracked by AlchemicalArrows
	 * 
	...
	/** 
	 * Get the registered/tracked arrows from AlchemicalArrows. May be used to manipulate all
	 * current arrows
	 * 
	 * @return The registered AlchemicalArrow Map
	 */
	...
	/** 
	 * Get an instance of an alchemical arrow to be used for INFORMATIONAL PURPOSES! (i.e. 
	 * to retrieve data from methods)
	 * <br><b>NOTE:</b> The instance of AlchemicalArrow provides a null arrow parameter
	 * 
	 * @param clazz - The arrow to create
	 * @return an instance of an alchemical arrow
	 */
	...
	/**
	 * Clear all registered in-world arrows from the map
	 */
